...
<html lang="en">
  ...
  <body>
          ...
          <div class="col-lg-4 col-md-12 col-xs-12">
            <div class="content-left text-right">
              ...
              <div class="box-item left">
                ...
                <div class="text">
                  <h4>24/7 Support</h4>
                  <p>We are developing a new website with 24/7 customer support</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team wow fadeInUp" data-wow-delay="0.3s">
              ...
              <div class="team-details">
                <div class="team-inner">
                  <h4 class="team-title">Abebe wolde</h4>
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team wow fadeInUp" data-wow-delay="0.4s">
              ...
              <div class="team-details">
                <div class="team-inner">                  
                  <h4 class="team-title">Jarso Mekbeb</h4>
                  <p>Representative</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team wow fadeInUp" data-wow-delay="0.5s">
              ...
              <div class="team-details">
                <div class="team-inner">
                  <h4 class="team-title">Meskerem hailu</h4>
                  <p>Application Process Speacilist</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <div id="pricing" class="section pricing-section">
      <div class="container">
        <div class="section-header">   
          <p class="btn btn-subtitle wow fadeInDown" data-wow-delay="0.2s">Pricing information</p>       
            ...
            <div class="download-wrapper wow fadeInRight" data-wow-delay="0.2s">
              <div>
                <div class="download-text">
                  <h4>Login place</h4>
                  <p>Please sign-in or register to get access our service.</p>
                </div>
                <p>ddfgdfgfg</p>
                <a href="#" class="btn btn-common btn-effect"><i class="lni-android"></i> Login<br></a>
                <a href="#" class="btn btn-apple"><i class="lni-apple"></i> Register<br></a>
              </div>
            </div>
          </div>
        </div>
